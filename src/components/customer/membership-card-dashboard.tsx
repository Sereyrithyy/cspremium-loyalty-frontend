            ...
            <div className="relative flex h-full flex-col justify-between">
              ...
              <div className="flex items-end justify-between gap-6">
                <div className="min-w-0 flex-1">
                  <p className="font-display text-2xl font-light tracking-tight text-ivory sm:text-2xl">
                    {customer.name}
                  </p>
                  
                  <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[10px] tracking-wider text-mist/60">
                  ...
                  <div className="mt-4 flex items-end gap-3">
                    <div>
                      <p className="text-[8px] font-light uppercase tracking-[0.25em] text-mist/40">
                        Points Balance
                      </p>
